(function () {
  ...
  var resources = [
    ...
    { type: 'recommendation', name: 'Noosh Baratpour', org: 'Co-founder & CMO · Formaloo', file: 'https://assets.gabrieldalton.com/References/Gabriel_Dalton_Letter_of_Recommendation_Formaloo_CMO.pdf', summary: 'On the Product Marketing Manager (PMM) internship at Formaloo and direct collaboration with the CMO.' },
    { type: 'recommendation', name: 'Adrien de Malherbe', org: 'Co-Founder · Refoorest', file: 'https://assets.gabrieldalton.com/References/Gabriel_Dalton_Letter_of_Recommendation_Adrien_de_Malherbe.pdf', summary: 'On SEO, content, and digital strategy work supporting Refoorest\'s tree-planting growth.' },
    { type: 'recommendation', name: 'Farooq Khan', org: 'President · Denman Place Mall', file: 'https://assets.gabrieldalton.com/References/Gabriel_Dalton_Letter_of_Recommendation_Farooq_Khan.pdf', summary: 'On the Denman Place Mall website redevelopment and securing roughly $330,000 in in-kind nonprofit technology grants.' },
    { type: 'recommendation', name: 'Jordan Mittler', org: 'Founder & CEO · Mittler Senior Technology', file: 'https://assets.gabrieldalton.com/References/Gabriel_Dalton_Letter_of_Recommendation_Jordan_Mittler.pdf', summary: 'On leading the sustainability department and rebuilding the MST website for accessibility.' },
    { type: 'recommendation', name: 'Michael Andersen', org: 'Founder · Sustainable WWW', file: 'https://assets.gabrieldalton.com/References/Gabriel_Dalton_Letter_of_Recommendation_Michael_Andersen_Sustainable_WWW.pdf', summary: 'On volunteering at Sustainable WWW and championing a tree-planting integration that was implemented after research.' },
    { type: 'recommendation', name: 'Jack Wood', org: "Financial Assistant · St. Paul's Anglican Church", file: 'https://assets.gabrieldalton.com/References/Gabriel_Dalton_Letter_of_Recommendation_Jack_Wood.pdf', summary: 'On the parish website redevelopment and a roughly 90% reduction in hosting costs.' },
    { type: 'recommendation', name: 'Sara Ciantar', org: "Office Administrator & Program Director · St. Paul's Anglican Church", file: 'https://assets.gabrieldalton.com/References/Gabriel_Dalton_Letter_of_Recommendation_Sara_Ciantar.pdf', summary: 'On launching the parish website on time, with discipline and craft.' },

    // ===== Letters of recognition / appreciation (PDFs) =====
    { type: 'recognition', name: 'Hon. Patty Hajdu', org: 'Minister of Jobs and Families · Government of Canada', file: 'https://assets.gabrieldalton.com/References/Gabriel_Dalton_Letter_of_Recognition_Patty_Hajdu.pdf', summary: 'A federal letter of recognition.' },
    { type: 'recognition', name: 'Hon. Spencer Chandra Herbert', org: 'MLA · Vancouver West End & Coal Harbour', file: 'https://assets.gabrieldalton.com/References/Gabriel_Dalton_Letter_of_Recognition_Spencer_Chandra_Hebert.pdf', summary: 'A provincial letter of recognition for community contribution and youth leadership.' },
    { type: 'recognition', name: 'Stanley Park Ecology Society', org: 'Tricia Collingham, Executive Director · Certificate of Appreciation', file: 'https://assets.gabrieldalton.com/References/Gabriel_Dalton_Certificate_of_Appreciation_SPES.pdf', summary: 'A certificate of appreciation for the SPES digital sustainability engagement.' },
