(function () {
  ...
  var resources = [
    ...
    { type: 'recommendation', name: 'Adrien de Malherbe', org: 'Managing Director · MA in Capital Markets & Securities', file: 'https://assets.gabrieldalton.com/Gabriel_Dalton_Letter_of_Recommendation_Adrien_de_Malherbe.pdf', summary: 'A letter of recommendation from a senior leader at a global investment-banking program.' },
    { type: 'recommendation', name: 'Farooq Khan', org: 'Founder · ViRA360', file: 'https://assets.gabrieldalton.com/Gabriel_Dalton_Letter_of_Recommendation_Farooq_Khan.pdf', summary: 'On collaboration on SEO content, website usability, and eco-friendly digital practices.' },
    { type: 'recommendation', name: 'Jack Wood', org: "Financial Assistant · St. Paul's Anglican Church", file: 'https://assets.gabrieldalton.com/Gabriel_Dalton_Letter_of_Recommendation_Jack_Wood.pdf', summary: 'On the redevelopment of the parish website and a 90% reduction in hosting costs.' },
    { type: 'recommendation', name: 'Jordan Mittler', org: 'Founder · Mittler Senior Technology', file: 'https://assets.gabrieldalton.com/Gabriel_Dalton_Letter_of_Recommendation_Jordan_Mittler.pdf', summary: 'On leading sustainability work and rebuilding the MST website for accessibility.' },
    { type: 'recommendation', name: 'Sara Ciantar', org: "Office Administrator · St. Paul's Anglican Church", file: 'https://assets.gabrieldalton.com/Gabriel_Dalton_Letter_of_Recommendation_Sara_Ciantar.pdf', summary: 'On launching the parish website on time, with discipline and craft.' },

    // ===== Letters of recognition / appreciation (PDFs) =====
    { type: 'recognition', name: 'Hon. Patty Hajdu', org: 'Member of Parliament · Government of Canada', file: 'https://assets.gabrieldalton.com/Gabriel_Dalton_Letter_of_Recognition_Patty_Hajdu.pdf', summary: 'A letter of recognition from a federal Minister.' },
    { type: 'recognition', name: 'Hon. Spencer Chandra Herbert', org: 'MLA · Province of British Columbia', file: 'https://assets.gabrieldalton.com/Gabriel_Dalton_Letter_of_Recognition_Spencer_Chandra_Hebert.pdf', summary: 'A provincial letter of recognition for community contribution and youth leadership.' },
    { type: 'recognition', name: 'Stanley Park Ecology Society', org: 'Certificate of Appreciation', file: 'https://assets.gabrieldalton.com/Gabriel_Dalton_Certificate_of_Appreciation_SPES.pdf', summary: 'A certificate of appreciation for the SPES digital sustainability engagement.' },
